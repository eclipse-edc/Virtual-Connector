...
@Testcontainers
public class PostgresTasksVirtualCompatibilityDockerTest extends DspCompatibilityDockerTestBase {
    ...
    static final RuntimeExtension RUNTIME = ComponentRuntimeExtension.Builder.newInstance()
            .name(CONNECTOR)
            .modules(":system-tests:runtimes:tck:tck-controlplane-postgres-tasks")
            .configurationProvider(PostgresTasksVirtualCompatibilityDockerTest::runtimeConfiguration)
