...
@EndToEndTest
@Testcontainers
public class MemoryTasksEdcVirtualCompatibilityDockerTest extends DspCompatibilityDockerTestBase {
    ...
    protected static RuntimeExtension runtime = ComponentRuntimeExtension.Builder.newInstance()
            .name(CONNECTOR)
            .modules(":system-tests:runtimes:tck:tck-controlplane-memory-tasks")
            .configurationProvider(MemoryTasksEdcVirtualCompatibilityDockerTest::runtimeConfiguration)
            .build();
