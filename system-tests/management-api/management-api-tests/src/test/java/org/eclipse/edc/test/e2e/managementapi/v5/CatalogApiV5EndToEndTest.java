    ...
    abstract static class Tests {
        ...
        void requestCatalog_tokenBearerNotOwner(ManagementEndToEndTestContext context,
            ...
            context.baseRequest(token)
                    .contentType(JSON)
                    .body(requestBody)
                    .post("/v5alpha/participants/%s/catalog/request".formatted(PARTICIPANT_CONTEXT_ID))
                    .then()
        ...
        void getDataset_shouldReturnDataset(ManagementEndToEndTestContext context, AssetIndex assetIndex,
            ...
            context.baseRequest(participantTokenJwt)
                    .contentType(JSON)
                    .body(requestBody)
                    .post("/v5alpha/participants/%s/catalog/dataset/request".formatted(PARTICIPANT_CONTEXT_ID))
                    .then()
                    .log().ifValidationFails()
                    .statusCode(200)
                    .contentType(JSON)
