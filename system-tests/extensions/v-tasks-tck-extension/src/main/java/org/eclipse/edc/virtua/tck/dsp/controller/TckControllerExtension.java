...
package org.eclipse.edc.virtua.tck.dsp.controller;
...
public class TckControllerExtension implements ServiceExtension {
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        webService.registerResource(PROTOCOL, new TckWebhookController(monitor, negotiationService, transferProcessService, participantContextService));
    }
