...
public class GuardAssembly {
    ...
    public static StepRecorder<TransferProcess> createTransferProcessRecorder(TransferProcessGuardTask tckTask) {
        ...
        recordProvider02TransferSequences(recorder, tckTask);
        recordProvider03TransferSequences(recorder, tckTask);
    ...
    private static void recordProvider02TransferSequences(StepRecorder<TransferProcess> recorder, TransferProcessGuardTask tckTask) {
        recorder.sequence("ATP0205").skip()
                .proceed();
    }

    private static void recordProvider03TransferSequences(StepRecorder<TransferProcess> recorder, TransferProcessGuardTask tckTask) {
    ...
    private static void block(ContractNegotiation cn) {
        try {
            Thread.sleep(2000);
