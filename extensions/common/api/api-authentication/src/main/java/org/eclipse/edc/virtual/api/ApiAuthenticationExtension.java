...
package org.eclipse.edc.virtual.api;
...
import static org.eclipse.edc.virtual.api.ApiAuthenticationExtension.NAME;

@Extension(NAME)
public class ApiAuthenticationExtension implements ServiceExtension {

    public static final String NAME = "EDC-V Authentication Extension";
