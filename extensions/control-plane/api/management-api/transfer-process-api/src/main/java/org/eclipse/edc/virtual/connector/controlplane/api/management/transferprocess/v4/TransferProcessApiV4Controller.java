...
@Path("/v4alpha/participants/{participantContextId}/transferprocesses")
public class TransferProcessApiV4Controller implements TransferProcessApiV4 {
    ...
    public TransferProcessApiV4Controller(Monitor monitor, AuthorizationService authorizationService, ParticipantContextService participantContextService, TransferProcessService service, TypeTransformerRegistry transformerRegistry) {
    ...
    @Override
    public JsonArray queryTransferProcessesV4(@PathParam("participantContextId") String participantContextId,
    ...
    @RequiredScope("management-api:read")
    @Override
    public JsonObject getTransferProcessV4(@PathParam("participantContextId") String participantContextId,
    ...
    @RequiredScope("management-api:read")
    @Override
    public JsonObject getTransferProcessStateV4(@PathParam("participantContextId") String participantContextId,
                                                @PathParam("id") String id,
                                                @Context SecurityContext securityContext) {
    ...
    @Override
    public JsonObject initiateTransferProcessV4(@PathParam("participantContextId") String participantContextId,
    ...
    @RequiredScope("management-api:write")
    @Override
    public void terminateTransferProcessV4(@PathParam("participantContextId") String participantContextId,
                                           @PathParam("id") String id,
    ...
    @RequiredScope("management-api:write")
    @Override
    public void suspendTransferProcessV4(@PathParam("participantContextId") String participantContextId,
                                         @PathParam("id") String id,
    ...
    @RequiredScope("management-api:write")
    @Override
    public void resumeTransferProcessV4(@PathParam("participantContextId") String participantContextId,
                                        @PathParam("id") String id,
                                        @Context SecurityContext securityContext) {
