...
package org.eclipse.edc.virtual.connector.controlplane.api.management.transferprocess.v5;
...
public interface TransferProcessApiV5 {
    ...
    JsonArray queryTransferProcessesV5(String participantContextId, JsonObject querySpecJson, SecurityContext securityContext);
    ...
    JsonObject getTransferProcessV5(String participantContextId, String id, SecurityContext securityContext);
    ...
    JsonObject getTransferProcessStateV5(String participantContextId, String id, SecurityContext securityContext);
    ...
    JsonObject initiateTransferProcessV5(String participantContextId, JsonObject transferRequest, SecurityContext securityContext);
    ...
    void terminateTransferProcessV5(String participantContextId, String id, JsonObject terminateTransfer, SecurityContext securityContext);
    ...
    void suspendTransferProcessV5(String participantContextId, String id, JsonObject suspendTransfer, SecurityContext securityContext);
    ...
    void resumeTransferProcessV5(String participantContextId, String id, SecurityContext securityContext);
}
