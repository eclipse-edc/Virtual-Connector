...
package org.eclipse.edc.virtual.connector.controlplane.api.management.contractagreement;
...
@ApiTest
public abstract class BaseContractAgreementApiControllerTest extends RestControllerTestBase {

    protected final ContractAgreementService service = mock();
    ...
    private RequestSpecification baseRequest(String participantContextId) {
        return given()
                .baseUri("http://localhost:" + port + "/" + versionPath() + "/participants/" + participantContextId + "/contractagreements")
                .when();
    }
