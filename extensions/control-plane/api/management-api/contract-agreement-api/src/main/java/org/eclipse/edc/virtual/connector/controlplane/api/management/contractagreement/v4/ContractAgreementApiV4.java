...
public interface ContractAgreementApiV4 {
    ...
    JsonArray queryAgreementsV4(String participantContextId, JsonObject querySpecJson, SecurityContext securityContext);
    ...
    JsonObject getAgreementByIdV4(String participantContextId, String id, SecurityContext securityContext);
    ...
    JsonObject getNegotiationByAgreementIdV4(String participantContextId, String id, SecurityContext securityContext);
