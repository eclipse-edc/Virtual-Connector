...
public abstract class BaseContractAgreementApiController {
    ...
    public BaseContractAgreementApiController(ContractAgreementService service, AuthorizationService authorizationService, TypeTransformerRegistry transformerRegistry,
