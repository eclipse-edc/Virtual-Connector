...
package org.eclipse.edc.virtual.connector.controlplane.api.management.catalog.v5;
...
public interface CatalogApiV5 {
    ...
    void requestCatalogV4(String participantContextId, JsonObject request, @Suspended AsyncResponse response, SecurityContext context);
    ...
    void getDatasetV4(String participantContextId, JsonObject request, @Suspended AsyncResponse response, SecurityContext context);
