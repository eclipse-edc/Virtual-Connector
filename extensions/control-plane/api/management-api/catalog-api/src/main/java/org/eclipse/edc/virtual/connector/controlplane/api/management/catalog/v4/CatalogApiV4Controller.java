...
@Path("/v4alpha/participants/{participantContextId}/catalog")
public class CatalogApiV4Controller implements CatalogApiV4 {
    ...
    @Override
    public void requestCatalogV4(@PathParam("participantContextId") String participantContextId,
    ...
    @RequiredScope("management-api:read")
    @Override
    public void getDatasetV4(@PathParam("participantContextId") String participantContextId,
