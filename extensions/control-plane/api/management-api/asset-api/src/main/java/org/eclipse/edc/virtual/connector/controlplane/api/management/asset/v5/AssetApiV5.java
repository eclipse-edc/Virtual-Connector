...
package org.eclipse.edc.virtual.connector.controlplane.api.management.asset.v5;
...
public interface AssetApiV5 {
    ...
    JsonObject createAssetV5(String participantContextId, JsonObject asset, SecurityContext securityContext);
    ...
    JsonArray queryAssetsV5(String participantContextId, JsonObject querySpecJson, SecurityContext securityContext);
    ...
    JsonObject getAssetV5(String participantContextId, String assetId, SecurityContext securityContext);
    ...
    void removeAssetV5(String participantContextId, String assetId, SecurityContext securityContext);
    ...
    void updateAssetV5(String participantContextId, JsonObject asset, SecurityContext securityContext);
