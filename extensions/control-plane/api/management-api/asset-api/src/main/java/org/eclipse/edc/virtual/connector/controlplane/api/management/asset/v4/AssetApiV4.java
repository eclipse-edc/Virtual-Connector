...
public interface AssetApiV4 {
    ...
    JsonObject createAsset(String participantContextId, JsonObject asset, SecurityContext securityContext);
    ...
    JsonArray queryAssets(String participantContextId, JsonObject querySpecJson, SecurityContext securityContext);
    ...
    JsonObject getAsset(String participantContextId, String assetId, SecurityContext securityContext);
    ...
    void removeAsset(String participantContextId, String assetId, SecurityContext securityContext);
    ...
    void updateAsset(String participantContextId, JsonObject asset, SecurityContext securityContext);
