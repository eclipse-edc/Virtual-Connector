...
package org.eclipse.edc.virtual.connector.controlplane.api.management.asset.v4;
...
public class AssetApiV4Controller implements AssetApiV4 {
    ...
    public AssetApiV4Controller(AssetService assetService, TypeTransformerRegistry managementTypeTransformerRegistry, JsonObjectValidatorRegistry validator, Monitor monitor, AuthorizationService authorizationService) {
    ...
    public JsonArray queryAssets(@PathParam("participantContextId") String participantContextId,
    ...
    @RequiredScope("management-api:read")
    @Override
    public void removeAsset(@PathParam("participantContextId") String participantContextId,
    ...
    @RolesAllowed({ParticipantPrincipal.ROLE_ADMIN, ParticipantPrincipal.ROLE_PARTICIPANT})
    @RequiredScope("management-api:write")
    public void updateAsset(@PathParam("participantContextId") String participantContextId,
                            @SchemaType({EDC_ASSET_TYPE_TERM, EDC_CATALOG_ASSET_TYPE_TERM}) JsonObject assetJson,
                            @Context SecurityContext securityContext) {
