...
package org.eclipse.edc.virtual.connector.controlplane.api.management.policy.v4;
...
@Path("/v4alpha/participants/{participantContextId}/policydefinitions")
public class PolicyDefinitionApiV4Controller implements PolicyDefinitionApiV4 {
    private final TypeTransformerRegistry typeTransformerRegistry;
    private final Monitor monitor;
    private final AuthorizationService authorizationService;
    private final PolicyDefinitionService policyDefinitionService;

    public PolicyDefinitionApiV4Controller(PolicyDefinitionService policyDefinitionService, TypeTransformerRegistry transformerRegistry, Monitor monitor, AuthorizationService authorizationService) {
    ...
    @Override
    public JsonArray queryPolicyDefinitionsV4(@PathParam("participantContextId") String participantContextId,
    ...
    @RequiredScope("management-api:read")
    @Override
    public JsonObject getPolicyDefinitionV4(@PathParam("participantContextId") String participantContextId,
    ...
    @Override
    public JsonObject createPolicyDefinitionV4(@PathParam("participantContextId") String participantContextId,
    ...
    @RequiredScope("management-api:write")
    @Override
    public void deletePolicyDefinitionV4(@PathParam("participantContextId") String participantContextId,
                                         @PathParam("id") String id,
                                         @Context SecurityContext securityContext) {
    ...
    @RequiredScope("management-api:write")
    @Override
    public void updatePolicyDefinitionV4(@PathParam("participantContextId") String participantContextId,
                                         @PathParam("id") String id,
    ...
    @RequiredScope("management-api:read")
    @Override
    public JsonObject validatePolicyDefinitionV4(@PathParam("participantContextId") String participantContextId,
                                                 @PathParam("id") String id,
                                                 @Context SecurityContext securityContext) {
    ...
    @RequiredScope("management-api:read")
    @Override
    public JsonObject createExecutionPlanV4(@PathParam("participantContextId") String participantContextId,
                                            @PathParam("id") String id,
