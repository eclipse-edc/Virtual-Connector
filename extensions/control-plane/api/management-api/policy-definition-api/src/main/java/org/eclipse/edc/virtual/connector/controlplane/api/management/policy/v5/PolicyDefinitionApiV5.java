...
package org.eclipse.edc.virtual.connector.controlplane.api.management.policy.v5;
...
@Tag(name = "Policy Definition v5alpha")
public interface PolicyDefinitionApiV5 {
    ...
    JsonArray queryPolicyDefinitionsV5(String participantContextId, JsonObject querySpecJson, SecurityContext securityContext);
    ...
    JsonObject getPolicyDefinitionV5(String participantContextId, String id, SecurityContext securityContext);
    ...
    JsonObject createPolicyDefinitionV5(String participantContextId, JsonObject policyDefinition, SecurityContext securityContext);
    ...
    void deletePolicyDefinitionV5(String participantContextId, String id, SecurityContext securityContext);
    ...
    void updatePolicyDefinitionV5(String participantContextId, String id, JsonObject policyDefinition, SecurityContext securityContext);
    ...
    JsonObject validatePolicyDefinitionV5(String participantContextId, String id, SecurityContext securityContext);
    ...
    JsonObject createExecutionPlanV5(String participantContextId, String id, JsonObject input, SecurityContext securityContext);
