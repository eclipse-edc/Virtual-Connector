...
public interface PolicyDefinitionApiV4 {
    ...
    JsonArray queryPolicyDefinitionsV4(String participantContextId, JsonObject querySpecJson, SecurityContext securityContext);
    ...
    JsonObject getPolicyDefinitionV4(String participantContextId, String id, SecurityContext securityContext);
    ...
    JsonObject createPolicyDefinitionV4(String participantContextId, JsonObject policyDefinition, SecurityContext securityContext);
    ...
    void deletePolicyDefinitionV4(String participantContextId, String id, SecurityContext securityContext);
    ...
    void updatePolicyDefinitionV4(String participantContextId, String id, JsonObject policyDefinition, SecurityContext securityContext);
    ...
    JsonObject validatePolicyDefinitionV4(String participantContextId, String id, SecurityContext securityContext);
    ...
    JsonObject createExecutionPlanV4(String participantContextId, String id, JsonObject input, SecurityContext securityContext);
