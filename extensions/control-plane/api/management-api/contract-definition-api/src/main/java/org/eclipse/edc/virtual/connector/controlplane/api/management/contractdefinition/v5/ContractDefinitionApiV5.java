...
package org.eclipse.edc.virtual.connector.controlplane.api.management.contractdefinition.v5;
...
@Tag(name = "Contract Definition v5alpha")
public interface ContractDefinitionApiV5 {
    ...
    JsonArray queryContractDefinitionsV5(String participantContextId, JsonObject querySpecJson, SecurityContext securityContext);
    ...
    JsonObject getContractDefinitionV5(String participantContextId, String id, SecurityContext securityContext);
    ...
    JsonObject createContractDefinitionV5(String participantContextId, JsonObject createObject, SecurityContext securityContext);
    ...
    void deleteContractDefinitionV5(String participantContextId, String id, SecurityContext securityContext);
    ...
    void updateContractDefinitionV5(String participantContextId, JsonObject updateObject, SecurityContext securityContext);
