...
public interface ContractDefinitionApiV4 {
    ...
    JsonArray queryContractDefinitionsV4(String participantContextId, JsonObject querySpecJson, SecurityContext securityContext);
    ...
    JsonObject getContractDefinitionV4(String participantContextId, String id, SecurityContext securityContext);
    ...
    JsonObject createContractDefinitionV4(String participantContextId, JsonObject createObject, SecurityContext securityContext);
    ...
    void deleteContractDefinitionV4(String participantContextId, String id, SecurityContext securityContext);
    ...
    void updateContractDefinitionV4(String participantContextId, JsonObject updateObject, SecurityContext securityContext);
