...
package org.eclipse.edc.virtualized.connector.controlplane.api.management.contractdefinition.v4;
...
@Path("/v4alpha/participants/{participantContextId}/contractdefinitions")
public class ContractDefinitionApiV4Controller implements ContractDefinitionApiV4 {
    ...
    public ContractDefinitionApiV4Controller(TypeTransformerRegistry typeTransformerRegistry, ContractDefinitionService contractDefinitionService, Monitor monitor, AuthorizationService authorizationService) {
    ...
    public JsonArray queryContractDefinitionsV4(@PathParam("participantContextId") String participantContextId,
    ...
    @Override
    public JsonObject createContractDefinitionV4(@PathParam("participantContextId") String participantContextId,
    ...
    @RequiredScope("management-api:write")
    @Override
    public void deleteContractDefinitionV4(@PathParam("participantContextId") String participantContextId,
                                           @PathParam("id") String id,
                                           @Context SecurityContext securityContext) {
        authorizationService.authorize(securityContext, participantContextId, id, ContractDefinition.class)
                .orElseThrow(exceptionMapper(ContractDefinition.class, id));
    ...
    @RequiredScope("management-api:write")
    @Override
    public void updateContractDefinitionV4(@PathParam("participantContextId") String participantContextId,
