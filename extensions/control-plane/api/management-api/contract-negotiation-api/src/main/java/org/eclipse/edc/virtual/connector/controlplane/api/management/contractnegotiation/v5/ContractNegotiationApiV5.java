...
package org.eclipse.edc.virtual.connector.controlplane.api.management.contractnegotiation.v5;
...
@Tag(name = "Contract Negotiation v5alpha")
public interface ContractNegotiationApiV5 {
    ...
    JsonArray queryNegotiationsV5(String participantContextId, JsonObject querySpecJson, SecurityContext securityContext);
    ...
    JsonObject getNegotiationV5(String participantContextId, String id, SecurityContext securityContext);
    ...
    JsonObject getNegotiationStateV5(String participantContextId, String id, SecurityContext securityContext);
    ...
    JsonObject getAgreementForNegotiationV5(String participantContextId, String negotiationId, SecurityContext securityContext);
    ...
    JsonObject initiateContractNegotiationV5(String participantContextId, JsonObject requestDto, SecurityContext securityContext);
    ...
    void deleteNegotiationV5(String participantContextId, String id, SecurityContext securityContext);
