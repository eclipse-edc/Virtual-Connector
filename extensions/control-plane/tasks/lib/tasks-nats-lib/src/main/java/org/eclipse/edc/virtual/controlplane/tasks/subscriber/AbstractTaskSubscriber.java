...
package org.eclipse.edc.virtual.controlplane.tasks.subscriber;
...
public abstract class AbstractTaskSubscriber<P extends ProcessTaskPayload> extends NatsSubscriber {
    ...
    @SuppressWarnings("unchecked")
    public abstract static class Builder<T extends AbstractTaskSubscriber<P>, B extends AbstractTaskSubscriber.Builder<T, B, P>, P extends ProcessTaskPayload> extends NatsSubscriber.Builder<T, Builder<T, B, P>> {
