...
import static org.eclipse.edc.virtual.controlplane.iam.decentralizedclaims.scope.core.DcpScopeConfigurationExtension.NAME;


@Extension(NAME)
public class DcpScopeConfigurationExtension implements ServiceExtension {

    public static final String NAME = "DCP Scope Configuration Extension";
    ...
    private void addScope(Config config) {
        ...
        var scope = DcpScope.Builder.newInstance().id(id)
                .type(DcpScope.DcpScopeType.valueOf(type.toUpperCase()))
                .value(value)
