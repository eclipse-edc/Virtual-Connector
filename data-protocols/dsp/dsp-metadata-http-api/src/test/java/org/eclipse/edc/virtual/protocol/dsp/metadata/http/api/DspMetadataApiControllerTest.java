...
class DspMetadataApiControllerTest extends RestControllerTestBase {
    ...
    void shouldInvokeRequestHandler() {
        ...
        var output = Json.createObjectBuilder()
                .add("protocolVersions", Json.createArrayBuilder()
                        .add(Json.createObjectBuilder()
                                .add("version", "version")
                                .add("path", "/participantcontextId/1.0")
        ...
        baseRequest()
                ...
                .body("protocolVersions[0].path", is("/participantcontextId/1.0"))
    ...
    protected Object controller() {
        return new DspMetadataApiController(participantContextService, service, transformerRegistry);
    }
